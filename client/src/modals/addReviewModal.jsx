              ...
              <form className="login-form" onSubmit={handleSubmit}>
                ...
                <div className="px-4 py-3 align-self-center sm:px-6">
                  <div className="text-center">
                    ...
                    <button
                      className="inline-flex w-full justify-center rounded-md border border-transparent bg-neutral-500 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm"
                      onClick={() => props.setAddReview(false)}
                    >
                        Cancel
                    </button>
                  </div>
