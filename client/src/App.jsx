  ...
  return (
    <div className="flex justify-center text-center flex-col font-mono">
      ...
      <div className="flex flex-row font-mono py-2">
        ...
        {/* Drop down section  */}
        <div className={userLoggedIn ? "flex justify-end flex-col item-center" : "hidden"}>
          <button onClick={() => {setDropDown(dropdown=> !dropdown)}} id="Profile" data-dropdown-toggle="options" 
            className="text-red-700 bg-white hover:bg-white-800 focus:ring-1 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center hover:bg-gray-100 " type="button">
          ...
          {/* <Collapsible className={userLoggedIn ? "text-red-900 font-bold accordion-item bg-white border border-gray-200 collapse-arrow" : "hidden"} trigger={username} src="">
            ...
            <button className={userLoggedIn ? "hidden" : "block"}
              onClick={() => {
                setSignIn(!signIn);
              }}
            >
            ...
            <button
              className={userLoggedIn ? "hidden" : "bg-red-800 rounded-lg p-1 text-yellow-300"}
              onClick={() => {
                setSignUp(!signUp);
              }}
            >
